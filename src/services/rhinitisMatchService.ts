        ...
        criteria: [
          {
            ...
            description: '1年以上屋尘螨或粉尘螨过敏性鼻炎/鼻结膜炎诊断',
            formField: 'egfrMutation',
            acceptedValues: ['1年以上屋尘螨或粉尘螨过敏性鼻炎/鼻结膜炎诊断'],
            weight: 5,
            required: true
          },
          {
            id: 'c1_2',
            type: CriteriaType.INCLUSION,
            description: '年龄12-65岁之间',
            formField: 'lungCancerType',
            acceptedValues: ['年龄12-65岁之间'],
            weight: 3,
            required: true
          },
          {
            id: 'c1_3',
            type: CriteriaType.INCLUSION,
            description: '不可处于妊娠状态',
            formField: 'cancerStage',
            acceptedValues: ['不可处于妊娠状态'],
            weight: 2,
            required: true
          },
          {
            ...
            description: '不可对霉菌、蟑螂、热带螨或其他地域相关螨虫过敏',
            formField: 'inOtherStudy',
            rejectedValues: ['不可对霉菌、蟑螂、热带螨或其他地域相关螨虫过敏'],
            weight: 1,
            required: true
          }
        ]
        ...
        criteria: [
          {
            id: 'c2_1',
            type: CriteriaType.INCLUSION,
            description: '有1年以上尘螨过敏性鼻炎/鼻结膜炎的诊断',
            formField: 'lungCancerType',
            acceptedValues: ['有1年以上尘螨过敏性鼻炎/鼻结膜炎的诊断'],
            weight: 3,
            required: true
          },
          {
          ...
          },
          {
            id: 'c2_3',
            type: CriteriaType.INCLUSION,
            description: '1年内接受过抗过敏药物治疗，但仍有过敏性鼻炎症状',
            formField: 'cancerStage',
            acceptedValues: ['1年内接受过抗过敏药物治疗，但仍有过敏性鼻炎症状'],
            weight: 2,
            required: true
          }
        ]
